...
{
    public class ClassicPokerArchetypeHelperBase : IPokerArchetypeHelperBase
    {
        ...
        public ClassicPokerArchetypeHelperBase(ISetDiagnosticsTool passedSetDiagnosticsTool, ISetDataMatcher passedSetDataMatcher, PokerPatternCheckingPackage passedPatternCheckingPackage)
        {
