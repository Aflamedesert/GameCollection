...
{
    public class PokerPairArchetype : IPokerHandArchetype
    {
        ...
        public PokerPairArchetype(List<IPokerCard> passedCards, AbstractHighKindValueIterator passedHighKindIterator, AbstractHighCardValueIterator passedHighCardIterator)
        {
