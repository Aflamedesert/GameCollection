...
namespace GameCollection.Games.Poker.PokerHandArchetypes
{
    class PokerThreeOfAKindArchetype : IPokerHandArchetype
    {
        ...
        public PokerThreeOfAKindArchetype(List<IPokerCard> passedCards, AbstractHighKindValueIterator passedHighKindIterator, AbstractHighCardValueIterator passedHighCardIterator)
        {
